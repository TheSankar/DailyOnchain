...
import { inkchain, sonieum, unichain } from './config/chains';
                ...
                {!isConnected ? (
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-400 mb-10 max-w-lg mx-auto">
                            Connect your wallet to start your on-chain streak across the Superchain ecosystem.
                        </p>
                    ...
                    <>
                        ...
                        <div className="text-center mb-16 animate-fade-in-up">
                            <h1 className="text-4xl md:text-6xl font-light mb-3 text-white">
                                Hey ! <span className="font-normal opacity-90">onchain maxi</span>
                            </h1>
                            <p className="text-lg text-gray-400 font-light tracking-wide">
                                Keep your streak with major L2s
                            </p>
                        </div>

                        <div className="flex flex-wrap justify-center gap-8 md:gap-12 animate-fade-in-up delay-100">
                            {CHAINS.map((item) => (
                                <ChainIcon
                                    key={item.chain.id}
